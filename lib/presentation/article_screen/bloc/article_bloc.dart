...
import 'package:healthcare_dhiwise/presentation/article_screen/models/article_model.dart';
...
class ArticleBloc extends Bloc<ArticleEvent, ArticleState> {
  ...
  List<RelatedarticlesItemModel> fillRelatedarticlesItemList() {
    return [
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        articleModelObj: state.articleModelObj?.copyWith(
            ...
            relatedarticlesItemList: fillRelatedarticlesItemList())));
  }
}
